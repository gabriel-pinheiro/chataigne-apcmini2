...
export const moduleDefinition: Definition = {
  ...
  url: "https://github.com/gabriel-pinheiro/chataigne-apcmini2",
  downloadURL: "https://github.com/gabriel-pinheiro/chataigne-apcmini2/archive/main.zip",
  hasInput: true,
  hasOutput: true,
    ...
    General: container(
      {
        Blackout: {
          ...
          shortName: "blackout",
          default: false,
          description: "Force all pad and Track/Scene LEDs off without changing their saved settings. Supported in Session Mode."
        },
        "Pad Brightness": {
          type: "Enum",
          shortName: "padBrightness",
          default: "Full",
          options: {
            Full: "full",
            Dim: "dim"
          },
          description: "Full uses 100% and Dim uses 40%. Does not affect Track/Scene LEDs."
        }
      },
      false
    ),
